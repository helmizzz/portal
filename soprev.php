...
// }
$user_permissions = getUserPermissions($conn, $_SESSION['user_id']);
$can_manage_documents = in_array('manage_documentsrevsop', $user_permissions);
                ...
                <tbody>
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr>
                            ...
                            echo "<a class='view-pdf-btn' data-file='" . htmlspecialchars($row['file_name']) . "' data-tahun='" . htmlspecialchars($row['tahun']) . "' data-dept='" . htmlspecialchars($row['nama_dept']) . "'><button class='view-pdf-btn btn btn-sm btn-light' data-bs-toggle='dropdown' data-bs-boundary='viewport'><i class='fa-solid fa-eye'></i></a></button>";
