...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2025 at 08:43 PM
...
-- Database: `pdfviewer`
--
CREATE DATABASE IF NOT EXISTS `pdfviewer` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `pdfviewer`;
...
INSERT INTO `users` (`id`, `username`, `password`, `departement_id`, `role`) VALUES
(1, 'admin', '$2y$10$GnYvbqHJCFJZA2j9SGUvju/O6vzDu7rGXXl4tMxcdgNX2xmluHS32', NULL, 'admin'),
(2, 'budi', '$2y$10$GnYvbqHJCFJZA2j9SGUvju/O6vzDu7rGXXl4tMxcdgNX2xmluHS32', 1, 'user'),
(3, 'siti', '$2y$10$GnYvbqHJCFJZA2j9SGUvju/O6vzDu7rGXXl4tMxcdgNX2xmluHS32', 2, 'user'),
(4, 'haryo', '$2y$10$GnYvbqHJCFJZA2j9SGUvju/O6vzDu7rGXXl4tMxcdgNX2xmluHS32', 3, 'user');
...
('root', '[{\"db\":\"pdfviewer\",\"table\":\"folders\"},{\"db\":\"pdfviewer\",\"table\":\"documents\"},{\"db\":\"pdfviewer\",\"table\":\"activity_logs\"},{\"db\":\"pdfviewer\",\"table\":\"users\"},{\"db\":\"pdfviewer\",\"table\":\"departements\"},{\"db\":\"pdfviewer\",\"table\":\"carousel_images\"},{\"db\":\"pdfviewer\",\"table\":\"document_permissions\"}]');
...
('root', '2025-08-01 18:43:27', '{\"Console\\/Mode\":\"collapse\"}');
